...
namespace ToanvaTrung_PhanMemQuanLySinhVien_19CT112 {
    ...
    public partial class QLSVDataSet : global::System.Data.DataSet {
        ...
        public partial class SinhVienDataTable : global::System.Data.TypedTableBase<SinhVienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public SinhVienRow AddSinhVienRow(string MaSV, string HoTen, string GioiTinh, System.DateTime NgaySinh, string DiaChi, string MaLop) {
...
namespace ToanvaTrung_PhanMemQuanLySinhVien_19CT112.QLSVDataSetTableAdapters {
    ...
    public partial class SinhVienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[SinhVien] ([MaSV], [HoTen], [GioiTinh], [NgaySinh], [DiaChi], " +
                "[MaLop]) VALUES (@MaSV, @HoTen, @GioiTinh, @NgaySinh, @DiaChi, @MaLop);\r\nSELECT " +
                "MaSV, HoTen, GioiTinh, NgaySinh, DiaChi, MaLop FROM SinhVien WHERE (MaSV = @MaSV" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[SinhVien] SET [MaSV] = @MaSV, [HoTen] = @HoTen, [GioiTinh] = @GioiTinh, [NgaySinh] = @NgaySinh, [DiaChi] = @DiaChi, [MaLop] = @MaLop WHERE (([MaSV] = @Original_MaSV) AND ((@IsNull_HoTen = 1 AND [HoTen] IS NULL) OR ([HoTen] = @Original_HoTen)) AND ((@IsNull_GioiTinh = 1 AND [GioiTinh] IS NULL) OR ([GioiTinh] = @Original_GioiTinh)) AND ((@IsNull_NgaySinh = 1 AND [NgaySinh] IS NULL) OR ([NgaySinh] = @Original_NgaySinh)) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)) AND ((@IsNull_MaLop = 1 AND [MaLop] IS NULL) OR ([MaLop] = @Original_MaLop)));
SELECT MaSV, HoTen, GioiTinh, NgaySinh, DiaChi, MaLop FROM SinhVien WHERE (MaSV = @MaSV)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ToanvaTrung_PhanMemQuanLySinhVien_19CT112.Properties.Settings.Default.QLSVConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaSV, HoTen, GioiTinh, NgaySinh, DiaChi, MaLop FROM dbo.SinhVien";
        ...
        public virtual int Delete(string Original_MaSV, string Original_HoTen, string Original_GioiTinh, global::System.Nullable<global::System.DateTime> Original_NgaySinh, string Original_DiaChi, string Original_MaLop) {
        ...
        public virtual int Insert(string MaSV, string HoTen, string GioiTinh, global::System.Nullable<global::System.DateTime> NgaySinh, string DiaChi, string MaLop) {
            if ((MaSV == null)) {
        ...
        public virtual int Update(string MaSV, string HoTen, string GioiTinh, global::System.Nullable<global::System.DateTime> NgaySinh, string DiaChi, string MaLop, string Original_MaSV, string Original_HoTen, string Original_GioiTinh, global::System.Nullable<global::System.DateTime> Original_NgaySinh, string Original_DiaChi, string Original_MaLop) {
            if ((MaSV == null)) {
                throw new global::System.ArgumentNullException("MaSV");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string HoTen, string GioiTinh, global::System.Nullable<global::System.DateTime> NgaySinh, string DiaChi, string MaLop, string Original_MaSV, string Original_HoTen, string Original_GioiTinh, global::System.Nullable<global::System.DateTime> Original_NgaySinh, string Original_DiaChi, string Original_MaLop) {
            return this.Update(Original_MaSV, HoTen, GioiTinh, NgaySinh, DiaChi, MaLop, Original_MaSV, Original_HoTen, Original_GioiTinh, Original_NgaySinh, Original_DiaChi, Original_MaLop);
        }
    }
